<template>
  <div class="choice-wrapper">
    ...
    <nav-menu></nav-menu>
    <search-bar @select="select"></search-bar>

    <div class="check-wrapper">
      <div class="check-nav">
        <div class="current-position">
          <span><span>当前范围:</span>{{currentPosition}}</span>
        </div>
        <div class="user-count">
          <span>当前:{{ userCount }}人</span>
        </div>
      ...
      <van-popup v-model="showPicker" round position="bottom" class="popup">
        <van-picker
          show-toolbar
          :columns="columns"
...
export default {
  ...
  data() {
    return {
      ...
      value: "",
      showPicker: false,
      columns: ["全部", "八一路", "宝成路", "航空路", "学院路", "天仙路"],
      //当前范围
      currentPosition:"全部"
    };
  },
